  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Buchungsübersicht</h1>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Berater</label>
            <input
              type="text"
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left">Plattform</th>
                  ...
                  <th className="px-4 py-2 text-left">Berater</th>
                  <th className="px-4 py-2 text-left">Preis</th>
                  {isAdmin() && <th className="px-4 py-2 text-left">Aktionen</th>}
                </tr>
              </thead>
                ...
                {bookings.map(booking => {
                  ...
                  return (
                    <tr key={booking.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2">{booking.platform_name || '-'}</td>
                      <td className="px-4 py-2">{booking.product_name || '-'}</td>
                      <td className="px-4 py-2">{booking.location_name || '-'}</td>
                      <td className="px-4 py-2">{booking.category_name || '-'}</td>
                      <td className="px-4 py-2">{booking.campaign_name || '-'}</td>
                      <td className="px-4 py-2">
                      ...
                      <td className="px-4 py-2">{booking.berater}</td>
                      <td className="px-4 py-2">
